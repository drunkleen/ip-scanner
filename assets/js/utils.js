const translations = {
  'de': {
    ...
    "description": "Sichere und saubere IP für Cloudflare, um auf das kostenlose Internet zuzugreifen",
    "tools": "Werkzeuge",
  ...
  'fr': {
    ...
    "description": "IP sûre et propre pour accéder à Internet gratuitement via Cloudflare",
    "tools": "Outils",
  ...
  'ru': {
    ...
    "description": "Безопасный и чистый IP для доступа к свободному интернету через Cloudflare",
    "tools": "Инструменты",
  ...
  'es': {
    ...
    "description": "IP segura y limpia para que Cloudflare acceda al internet libre",
    "tools": "Herramientas",
    "ip-count": "Número de IPs",
    "max-latency": "Latencia máxima",
    "include-range": "Rangos a incluir (por ejemplo, 1.1.1.1/24,8,8,8,8/24)",
    "exclude-range": "Rangos a excluir (por ejemplo, 1, 88.25, 41,55)",
    "expressions": "Expresión regular (por ejemplo, ^88\\.172\\.|^101\\.)",
  ...
  'tr': {
    ...
    "description": "Ücretsiz internete erişim için güvenli ve temiz IP",
    "tools": "Araçlar",
    "ip-count": "IP Sayısı",
    "max-latency": "Maksimum Gecikme",
    "include-range": "Dahil edilecek aralıklar (örneğin, 1.1.1.1/24,8,8,8,8/24)",
    "exclude-range": "Dışlanacak aralıklar (örneğin, 1, 88.25, 41,55)",
    "expressions": "Düzenli ifade (örneğin, ^88\\.172\\.|^101\\.)",
  ...
  'zh': {
    ...
    "description": "Cloudflare 访问自由互联网所需的安全而清洁的 IP",
    "tools": "工具",
    "ip-count": "IP 数量",
    "max-latency": "最大延迟",
